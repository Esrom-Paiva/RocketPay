defmodule Rocketpay.Accounts.Operation do
  ...
  defp update_balance(repo, account, value, operation) do
    account
    |> operation_balance(value, operation)
    |> update_account(repo, account)
  end

  defp operation_balance(%Account{balance: balance}, value, operation) do
    value
    |> Decimal.cast()
  ...
  defp handle_cast(:error, _reason, _operation), do: {:error, "Invalid deposit value!"}
